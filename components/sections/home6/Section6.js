        ...
        <div className="container">
          <div className="row align-items-end">
            <div className="col-lg-7 mb-40">
              <h2 className="heading-1 text-linear-3">
                Enjoy the benefits of having everything in a single platform
              </h2>
            </div>
            <div className="col-lg-5 mb-40">
              <div className="box-info-num">
                <span className="text-linear-3 text-88-semibold">2.5x</span>
                <p className="text-md neutral-0">
                  Page and data loading speed. Improve user experience and order
                  conversion rate.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="card-enjoy">
                ...
                <div className="card-info">
                  ...
                  <p className="text-lg">
                    Eu morbi orci ultricies vel congue sagittis lgula urna
                    viverra vestibulum.
                  </p>
