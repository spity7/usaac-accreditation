            ...
            <div className="banner-inner pt-50">
              <div className="container">
                ...
                <h1 className="display-2 mb-40 mt-15 neutral-0">
                  📌 Multilingual Education Accreditation
                  <br />
                  (MEA)
                </h1>
            ...
            <div className="d-flex align-items-end justify-content-between box-head-plan mb-30">
              ...
              <div className="box-button-plan">
                <p className="fs-5 text-center">
                  The MEA framework ensures that schools provide high-quality
                  multilingual education that enhances cognitive development,
                  cross-cultural understanding, and global readiness.
                </p>
                        ...
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Dual-language instruction in core subjects.
                              </li>
                              <li>
                                <svg
                                  width={26}
                                ...
                                Language development plans for students based on
                                proficiency levels.
                              </li>
                              <li>
                                <svg
                                ...
                                Certified bilingual educators with training in
                              ...
                              <li>
                                ...
                                Formal language assessments for progress
                                tracking.
                              </li>
                              {/* <li>
                                <svg
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              💡 Structured bilingual programs ensuring
                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              ...
                              <li>
                                ...
                                Immersive experiences such as exchange programs,
                                language clubs
                              </li>
                              <li>
                                <svg
                              ...
                              <li>
                                ...
                                Multicultural celebrations to reinforce
                                linguistic
                              </li>
                              {/* <li>
                                <svg
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              🚀 Immersive learning with cultural and linguistic
                              integration.
                            </span>
                          </div>
                          {/* <div className="card-button">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Fully immersive trilingual/multilingual
                                curriculum.
                              </li>
                              <li>
                                <svg
                                ...
                                Global partnerships with international schools,
                                universities
                              </li>
                              <li>
                                <svg
                                ...
                                Certified native-level language instruction
                              </li>
                              <li>
                                <svg
                                  width={26}
                                ...
                                Dual/multiple diploma programs
                              </li>
                              {/* <li>
                                <svg
                                  width={26}
            ...
            <div className="row mt-90">
                ...
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      • Multilingual education embedded in the school's mission.
                    </p>
                    <p className="text-md neutral-700">
                      • Policy frameworks ensuring sustainable multilingual
                      growth.
                    </p>
                    <p className="text-md neutral-700">
                      • Partnerships with linguistic institutions and
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">2️⃣ Curriculum & Pedagogy</h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Bilingual & multilingual teaching models: Transitional,
                      dual-immersion, or content-based instruction.
                    </p>
                    <p className="text-md neutral-700">
                      • Assessment & certification (CEFR, DELF, TOEFL, DELE,
                      HSK, etc.).
                    </p>
                    <p className="text-md neutral-700">
                      • AI-driven adaptive learning tools for language
                      acquisition.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        3️⃣ Faculty Expertise & Professional Development
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Certified bilingual and multilingual educators.
                    </p>
                    <p className="text-md neutral-700">
                      • Continuous teacher training in language immersion
                      methodologies.
                    </p>
                    <p className="text-md neutral-700">
                      • Exchange programs for educators in multilingual
                      settings.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        4️⃣ Student Experience & Global Competence
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Language immersion through cultural exchange programs.
                    </p>
                    <p className="text-md neutral-700">
                      • Digital and experiential learning tools for multilingual
                      development.
                    </p>
                    <p className="text-md neutral-700">
                      • International student collaboration projects (pen pals,
                      global debates, Model UN).
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-lg-12 col-md-12">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        5️⃣ Evaluation, Impact & Continuous Improvement
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Standardized multilingual proficiency tracking.
                    </p>
                    <p className="text-md neutral-700">
                      • Student progress monitoring using AI analytics.
                    </p>
                    <p className="text-md neutral-700">
                      • Continuous assessment & accreditation renewal cycle.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="row">
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            Schools evaluate their multilingual program using an
                            MEA checklist.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            MEA auditors assess the curriculum, teaching
                            quality, and linguistic environment.
                          </p>
                        </div>
                      </div>
                    </div>
