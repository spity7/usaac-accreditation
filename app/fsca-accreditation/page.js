            ...
            <div className="banner-inner pt-50">
              <div className="container">
                ...
                <h1 className="display-2 mb-40 mt-15 neutral-0">
                  📌 Future Skills & Career Readiness Accreditation
                  <br />
                  (FSCA)
                </h1>
            ...
            <div className="d-flex align-items-end justify-content-between box-head-plan mb-30">
              ...
              <div className="box-button-plan">
                <p className="fs-5 text-center">
                  The FSCA framework ensures that schools equip students with
                  future-ready skills, career preparedness, and entrepreneurial
                  mindsets essential for success in an evolving global
                  workforce.
                </p>
                        ...
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Integration of STEM education and digital
                              ...
                              <li>
                                ...
                                Students engage in team-based projects and
                              ...
                              <li>
                                ...
                                Basic coding and computational thinking included
                                in the curriculum.
                              </li>
                              <li>
                                <svg
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              💡 Basic skill development in problem-solving,
                              coding, and teamwork.
                            </span>
                          </div>
                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Introduction to entrepreneurship and financial
                                literacy.
                              </li>
                              <li>
                                <svg
                              ...
                              <li>
                                ...
                                Career mentorship programs with professionals
                              ...
                              <li>
                                ...
                                Use of AI-driven career guidance tools to
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              🚀 Emphasis on entrepreneurship, real-world
                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Schools support student-led businesses and
                                innovation hubs.
                              </li>
                              <li>
                                <svg
                              ...
                              <li>
                                ...
                                Internship and apprenticeship programs embedded
                                in learning.
                              </li>
                              <li>
                                <svg
                                ...
                                AI-driven career tracking, personalized
                                upskilling, and job-matching platforms.
                              </li>
                              {/* <li>
                                <svg
                                  width={26}
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              🏆 Global leader in workforce readiness with
                              student-run startups & industry collaborations.
                            </span>
                          </div>
                          {/* <div className="card-button">
                            <Link className="btn btn-get-started" href="#">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        1️⃣ Leadership & Strategic Vision
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • School leadership supports career readiness initiatives.
                    </p>
                    <p className="text-md neutral-700">
                      • Collaborations with businesses, universities, and
                      workforce development organizations.
                    </p>
                    <p className="text-md neutral-700">
                      • Encouraging innovation, startup incubation, and
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      • AI, coding, robotics, data literacy, and IoT integrated
                      into subjects.
                    </p>
                    <p className="text-md neutral-700">
                      • Business skills, personal finance, and market analysis.
                    </p>
                    <p className="text-md neutral-700">
                      • Critical thinking, leadership, creativity, and teamwork.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        3️⃣ Career Readiness & Industry Integration
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Internships, apprenticeships, and shadowing
                      opportunities.
                    </p>
                    <p className="text-md neutral-700">
                      • Guidance from industry professionals and alumni
                      networks.
                    </p>
                    <p className="text-md neutral-700">
                      • Personalized career guidance using AI-driven student
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        4️⃣ Innovation & Technology Integration
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Use of AI, AR/VR, and digital simulation for
                      experiential learning.
                    </p>
                    <p className="text-md neutral-700">
                      • Ensuring responsible tech integration in schools.
                    </p>
                    <p className="text-md neutral-700">
                      • Platforms for prototyping, pitching, and scaling student
                      business ideas.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-12 col-md-12">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        5️⃣ Assessment & Continuous Improvement
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Evaluating students on skills, not just grades.
                    </p>
                    <p className="text-md neutral-700">
                      • Measuring student progress in employability, university
                      admissions, and entrepreneurship.
                    </p>
                    <p className="text-md neutral-700">
                      • Schools undergo periodic evaluation to maintain FSCA
                      status.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="row">
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            Schools evaluate their readiness using an FSCA
                            checklist.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="">
                      <div className="card-casestudy">
                        <div className="card-title">
                          <h6>
                            <span className="number">2</span>Evaluation & Site
                            Visit
                          </h6>
                        </div>
                        <div className="card-desc">
                          <p>
                            Auditors assess the curriculum, industry linkages,
                    ...
                    <div className="">
                      <div className="card-casestudy">
                        <div className="card-title">
                          <h6>
                            <span className="number">4</span>Ongoing Support &
                            Renewal
                          </h6>
                        </div>
                        <div className="card-desc">
