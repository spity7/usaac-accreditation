            ...
            <div className="banner-inner pt-50">
              <div className="container">
                ...
                <h1 className="display-2 mb-40 mt-15 neutral-0">
                  📌 Leadership & Character Development Accreditation
                  <br />
                  (LCA)
                </h1>
            ...
            <div className="d-flex align-items-end justify-content-between box-head-plan mb-30">
              ...
              <div className="box-button-plan">
                <p className="fs-5 text-center">
                  ...
                  personal growth to prepare students for success in life and
                  careers.
                </p>
                        ...
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Extracurricular leadership clubs (e.g., student
                                council, debate, Model UN).
                              </li>
                              <li>
                                <svg
                                  width={26}
                                ...
                                Basic character education focused on integrity,
                              ...
                              <li>
                                ...
                                Volunteerism and community service initiatives.
                              </li>
                              <li>
                                <svg
                                  width={26}
                                ...
                                School-wide leadership values and ethical
                                behavior policies
                              </li>
                              {/* <li>
                                <svg
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              💡 Offers leadership clubs and character-building
                              programs.
                            </span>
                          </div>
                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Student leadership training programs integrated
                                into the curriculum.
                              </li>
                              <li>
                                <svg
                                ...
                                Active student government with real
                              ...
                              <li>
                                ...
                                Mentorship programs pairing students with
                                professionals or faculty mentors.
                              </li>
                              <li>
                                <svg
                                  width={26}
                                ...
                                Service-learning projects with measurable
                                community impact.
                              </li>
                              {/* <li>
                                <svg
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              🚀 Develops student government, mentorship, and
                      ...
                      <div className="col-lg-4 col-md-6">
                        <div className="card-pricing card-pricing-2">
                          ...
                          <div className="card-lists">
                            ...
                            <ul className="list-feature">
                              <li>
                                ...
                                Comprehensive leadership curriculum including
                                ethics, diplomacy, and innovation.
                              </li>
                              <li>
                                <svg
                                  width={26}
                                ...
                                International collaborations on leadership and
                              ...
                              <li>
                                ...
                                Alumni network of successful leaders in various
                                fields
                              </li>
                              <li>
                                <svg
                                ...
                                Recognition in global leadership programs,
                          ...
                          <div className="card-price">
                            ...
                            <span className="text-sm neutral-500">
                              🏆 Recognized globally for producing ethical and
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        1️⃣ Leadership Philosophy & Institutional Commitment
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Leadership development embedded in the school’s mission
                      and policies.
                    </p>
                    <p className="text-md neutral-700">
                      • Commitment to cultivating ethical decision-making and
                      accountability.
                    </p>
                    <p className="text-md neutral-700">
                      • Partnerships with universities, leadership
                      organizations, and industry mentors.
                    </p>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        2️⃣ Character Education & Ethical Decision-Making
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Integration of ethical leadership principles across
                      subjects.
                    </p>
                    <p className="text-md neutral-700">
                      • Project-based learning focused on moral reasoning and
                      civic responsibility.
                    </p>
                    <p className="text-md neutral-700">
                      • Personal growth programs focusing on resilience,
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        3️⃣ Leadership Development & Experiential Learning
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Hands-on leadership experiences through student-led
                      governance.
                    </p>
                    <p className="text-md neutral-700">
                      • Opportunities for public speaking, debate, and
                      negotiations.
                    </p>
                    <p className="text-md neutral-700">
                      • Collaborative leadership training through
              ...
              <div className="col-lg-6 col-md-6">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    <Link href="#">
                      <h5 className="text-22-bold">
                        4️⃣ Community Engagement & Social Impact
                      </h5>
                    </Link>
                    <p className="text-md neutral-700">
                      • Service-learning projects with measurable community
                      impact.
                    </p>
                    <p className="text-md neutral-700">
                      • Mentorship initiatives with industry leaders and alumni.
                    </p>
                    <p className="text-md neutral-700">
                      • Student-led startups and entrepreneurial leadership
                      programs.
                    </p>
                  </div>
                </div>
              ...
              <div className="col-lg-12 col-md-12">
                <div className="card-preparing-2">
                  ...
                  <div className="card-info">
                    ...
                    <p className="text-md neutral-700">
                      • Character and leadership assessments integrated into
                      school evaluations.
                    </p>
                    <p className="text-md neutral-700">
                      • Ongoing development of student leadership portfolios.
                    </p>
                    <p className="text-md neutral-700">
                      • Recognition of outstanding student leadership
                      achievements through awards and fellowships.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="row">
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            Schools evaluate leadership programs and submit
                            documentation.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            LCA auditors assess student leadership programs,
                            ethics education, and impact projects.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            Schools receive LCA Standard, Advanced, or Best
                    ...
                    <div className="">
                      <div className="card-casestudy">
                        ...
                        <div className="card-desc">
                          <p>
                            Schools maintain accreditation through regular
                            assessments and leadership initiatives.
                          </p>
                        </div>
                      </div>
                    </div>
